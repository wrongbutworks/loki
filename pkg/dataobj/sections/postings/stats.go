...
type (
	// Stats provides statistics about a postings section.
	Stats struct {
...
// ReadStats returns statistics about the postings section. ReadStats returns an
// error if the postings section couldn't be inspected or if the provided ctx is
// canceled.
